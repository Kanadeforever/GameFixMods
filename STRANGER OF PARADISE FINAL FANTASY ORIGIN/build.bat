...
if not exist workspace\build\obj mkdir workspace\build\obj
"%MSVC_PATH%\bin\HostX64\x64\cl.exe" /nologo /LD /EHsc /utf-8 /O2 /Foworkspace\build\obj\ /Feworkspace\build\disable_bloom.asi workspace\src\dllmain.cpp workspace\src\hooks.cpp workspace\src\d3d11_proxy.cpp workspace\src\d3d11_context_proxy.cpp archive\minhook-master\src\buffer.c archive\minhook-master\src\hook.c archive\minhook-master\src\trampoline.c archive\minhook-master\src\hde\hde64.c /link /DLL /OUT:workspace\build\disable_bloom.asi user32.lib d3d11.lib dxgi.lib dxguid.lib psapi.lib ole32.lib
